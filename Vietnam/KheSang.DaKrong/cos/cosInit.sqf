...
COS_distance=125;//Set spawn distance
_aerielActivation=true;// Set if flying units can activate civilian Zones

blackListTowns = ["radio relay vandergrift", "LZ Savage", "Camp Sarge", "Indian Country", "Song DaKrong Valley", "Three Canyons", "Bru", "Jarai", "Highway 14"];// Remove towns from COS
...
COScivPool =["uns_civilian1","uns_civilian1_b1","uns_civilian1_b2","uns_civilian1_b3","uns_civilian2","uns_civilian2_b1","uns_civilian2_b2","uns_civilian2_b3","uns_civilian3","uns_civilian3_b1","uns_civilian3_b2","uns_civilian3_b3","uns_civilian4","uns_civilian4_b1","uns_civilian4_b2","uns_civilian4_b3"];	
COSmotPool =["uns_Type55"];
...
_rad=15;// Radius increase increment for finding minimum spawn points
...
_randomisation=10;
	if (_houses <= 10) 
		then {
	_civilians=0+ round(random _randomisation);// Civilians spawned
