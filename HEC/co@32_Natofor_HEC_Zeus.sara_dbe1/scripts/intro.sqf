...
if (hasInterface) then {
    ...
    [] spawn {
	    ...
	    titleText ["Created by M4RT14L edit by ||HEC|| & Grille", "BLACK IN",9999];
		0 fadesound 0;
		...
		titleText ["A L i V E - N A T O F O R  ACE3 edit by ||HEC|| & Grille", "BLACK IN",10];
		10 fadesound 0.9;
		_cam CamCommit 20;
		sleep 5;
		sleep 15;
		...
		_title = "<t size='1.2' color='#e5b348' shadow='1' shadowColor='#000000'>NATOFOR INSURGENCY | ALiVE</t>
