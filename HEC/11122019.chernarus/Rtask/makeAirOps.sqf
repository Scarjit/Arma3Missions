...
fn_spawnArtyMission = {
	...
	_crew1 = _armor createUnit ["CUP_O_TK_Engineer", [0,0,1], [], 0, "CAN_COLLIDE"];
	_crew1 moveInDriver _arty1;
	_crew2 = _armor createUnit ["CUP_O_TK_Engineer", [0,0,1], [], 0, "CAN_COLLIDE"];
	_crew2 moveInDriver _arty2;
	
	_grp1A = [getMarkerPos _markerAO, INDEPENDENT, (configfile >> "CfgGroups" >> "INDEP" >> "CUP_O_TK" >> "Infantry" >> "CUP_O_TK_InfantrySection")] call BIS_fnc_spawnGroup;
	nul = [_grp1A,getPos _radiohq] call BIS_fnc_taskDefend;
	
	_cars1 = createGroup INDEPENDENT;
	[_newPos3, 10, "CUP_O_LR_MG_TKA", _cars1] call BIS_fnc_spawnvehicle;
...
fn_spawnCasMission = {
	...
	[_newPos, 10, "CUP_O_T34_TKA", _tanques1] call BIS_fnc_spawnvehicle;
	nul = [_tanques1,getPos _mhq, 150] call BIS_fnc_taskPatrol;
	sleep 10;
	[_newPos, 10, "CUP_O_T55_TK", _tanques1] call BIS_fnc_spawnvehicle;
	sleep 10;
	[_newPos, 10, "CUP_O_T72_TKA", _tanques1] call BIS_fnc_spawnvehicle;
	sleep 10;
	[_newPos, 10, "CUP_O_BTR60_TK", _tanques1] call BIS_fnc_spawnvehicle;
	sleep 10;
	[_newPos, 10, "CUP_O_BMP2_TKA", _tanques1] call BIS_fnc_spawnvehicle;
...
fn_spawnConvoyMission = {
	...
	[_newPos, 10, "CUP_O_BTR60_TK", _convoy1] call BIS_fnc_spawnvehicle;
	nul = [_convoy1,getPos _shed2, 300] call BIS_fnc_taskPatrol;
	sleep 15;
	[_newPos, 10, "CUP_O_LR_SPG9_TKA", _convoy1] call BIS_fnc_spawnvehicle;
	sleep 15;
	[_newPos, 10, "CUP_O_LR_Transport_TKA", _convoy1] call BIS_fnc_spawnvehicle;
	sleep 15;
	[_newPos, 10, "CUP_O_LR_MG_TKA", _convoy1] call BIS_fnc_spawnvehicle;
	sleep 15;
	[_newPos, 10, "CUP_O_LR_MG_TKA", _convoy1] call BIS_fnc_spawnvehicle;
...
fn_spawnPlacementMission = {
	...
	_truck1 = createVehicle ["CUP_O_LR_Transport_TKA",[(getPos _warehouse select 0) + 15, getPos _warehouse select 1,0],[], 0, "NONE"];
	
	_grp1A = [getPos _warehouse, INDEPENDENT, (configfile >> "CfgGroups" >> "INDEP" >> "CUP_I_TK" >> "Infantry" >> "CUP_O_TK_InfantrySquad")] call BIS_fnc_spawnGroup;
	nul = [_grp1A,getpos _warehouse] call BIS_fnc_taskDefend;
	
	_AA2 = createGroup INDEPENDENT;
	[_newPos, 10, "CUP_O_LR_MG_TKA", _AA2] call BIS_fnc_spawnvehicle;
