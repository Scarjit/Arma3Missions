...
fn_spawnUavMission = {
	...
	_grp1S = [getMarkerPos _markerSO, INDEPENDENT, (configfile >> "CfgGroups" >> "INDEP" >> "CUP_I_TK" >> "Infantry" >> "CUP_O_TK_InfantrySquad")] call BIS_fnc_spawnGroup;
	nul = [_grp1S,getPos _uav, 150] call BIS_fnc_taskPatrol;
	
	_grp2S = [getMarkerPos _markerSO, INDEPENDENT, (configfile >> "CfgGroups" >> "INDEP" >> "CUP_I_TK" >> "Infantry" >> "CUP_O_TK_InfantrySquad")] call BIS_fnc_spawnGroup;
	nul = [_grp2S,getPos _uav, 200] call BIS_fnc_taskPatrol;
	
	_cars2 = createGroup INDEPENDENT;
	[getMarkerPos _markerSO, 10, "CUP_O_LR_MG_TKA", _cars2] call BIS_fnc_spawnvehicle;
...
fn_spawnPilotRescueMission = {
	...
	_grp1S = [getPos _wreck, INDEPENDENT, (configfile >> "CfgGroups" >> "INDEP" >> "CUP_I_TK" >> "Infantry" >> "CUP_O_TK_InfantrySquad")] call BIS_fnc_spawnGroup;
	nul = [_grp1S,getPos _wreck, 150] call BIS_fnc_taskPatrol;
	
	_grp2S = [getPos _wreck, INDEPENDENT, (configfile >> "CfgGroups" >> "INDEP" >> "CUP_I_TK" >> "Infantry" >> "CUP_O_TK_InfantrySquad")] call BIS_fnc_spawnGroup;
	nul = [_grp2S,getPos _wreck, 250] call BIS_fnc_taskPatrol;
	
	_cars3 = createGroup INDEPENDENT;
	[getMarkerPos _markerSO, 10, "CUP_O_LR_MG_TKA", _cars3] call BIS_fnc_spawnvehicle;
