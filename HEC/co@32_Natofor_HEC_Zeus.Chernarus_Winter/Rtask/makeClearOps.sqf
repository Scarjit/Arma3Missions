...
fn_spawnClearMission = {
	...
	[_newPos, 10, "CUP_O_LR_MG_TKA", _ifv1] call BIS_fnc_spawnvehicle;
	...
	_grp1C = [getMarkerPos _markerCO, INDEPENDENT, (configfile >> "CfgGroups" >> "Indep" >> "CUP_I_TK_GUE" >> "Infantry" >> "CUP_I_TK_GUE_Group")] call BIS_fnc_spawnGroup;
	nul = [_grp1C,getPos _mhq] call BIS_fnc_taskDefend;
	
	_grp2C = [getMarkerPos _markerCO, INDEPENDENT, (configfile >> "CfgGroups" >> "Indep" >> "CUP_I_TK_GUE" >> "Infantry" >> "CUP_I_TK_GUE_Group")] call BIS_fnc_spawnGroup;
	nul = [_grp2C,getPos _mhq, 200] call BIS_fnc_taskPatrol;
	
	_grp3C = [getMarkerPos _markerCO, INDEPENDENT, (configfile >> "CfgGroups" >> "Indep" >> "CUP_I_TK_GUE" >> "Infantry" >> "CUP_I_TK_GUE_Group")] call BIS_fnc_spawnGroup;
...
fn_spawnKillMission = {
	...
	_mrap = createVehicle ["CUP_O_LR_Transport_TKA",[(getMarkerpos _markerCO select 0) + 1, getMarkerpos _markerCO select 1,0],[], 0, "NONE"];
	
	_off = createGroup RESISTANCE;
	_officer1 = _off createUnit ["CUP_I_TK_GUE_Soldier_TL",[(getMarkerpos _markerCO select 0) + 3, getMarkerpos _markerCO select 1,0], [], 0, "NONE"];
	...
	[_newPos, 10, "CUP_O_LR_MG_TKA", _mrap1] call BIS_fnc_spawnvehicle;
...
fn_spawnAmmoMission = {
	...
	_grp1C = [_newPos, INDEPENDENT, (configfile >> "CfgGroups" >> "Indep" >> "CUP_I_TK_GUE" >> "Infantry" >> "CUP_I_TK_GUE_Group")] call BIS_fnc_spawnGroup;
...
fn_spawnComsMission = {
	...
	_grp1C = [getMarkerPos _markerCO, INDEPENDENT, (configfile >> "CfgGroups" >> "GUER" >> "CUP_O_TK" >> "Infantry" >> "CUP_O_TK_InfantrySquad")] call BIS_fnc_spawnGroup;
	nul = [_grp1C,getpos _movilhq, 100] call BIS_fnc_taskPatrol;
	
	_grp2C = [getMarkerPos _markerCO, INDEPENDENT, (configfile >> "CfgGroups" >> "GUER" >> "CUP_O_TK" >> "Infantry" >> "CUP_O_TK_InfantrySquad")] call BIS_fnc_spawnGroup;
...
fn_spawnClear2Mission = {
	...
	[_newPos, 10, "CUP_O_LR_MG_TKA", _car1] call BIS_fnc_spawnvehicle;
...
fn_spawnAntiairMission = {
	...
	_crew1 = _aacrew createUnit ["CUP_O_TK_Engineer", [0,0,1], [], 0, "CAN_COLLIDE"];
	_crew1 moveInCommander _artyaa;
	_crew2 = _aacrew createUnit ["CUP_O_TK_Engineer", [0,0,1], [], 0, "CAN_COLLIDE"];
	...
	_grp1C = [getPos _atrezzo, INDEPENDENT, (configfile >> "CfgGroups" >> "Indep" >> "CUP_I_TK_GUE" >> "Infantry" >> "CUP_I_TK_GUE_ATTeam")] call BIS_fnc_spawnGroup;
...
fn_spawnCaptureMission = {
	...
	_warlord = _wlordgrp createUnit ["CUP_I_TK_GUE_Soldier_TL", getMarkerPos _markerCO, [], 0, "NONE"];
	...
	_grp2C = [_newPos, INDEPENDENT, (configfile >> "CfgGroups" >> "Indep" >> "CUP_I_TK_GUE" >> "Infantry" >> "CUP_I_TK_GUE_Group")] call BIS_fnc_spawnGroup;
	nul = [_grp2C,getpos _warlord] call BIS_fnc_taskDefend;
	
	_grp3C = [_newPos, INDEPENDENT, (configfile >> "CfgGroups" >> "Indep" >> "CUP_I_TK_GUE" >> "Infantry" >> "CUP_I_TK_GUE_Group")] call BIS_fnc_spawnGroup;
